...
9. **Хамитов Камиль**
 ...
 БД — ~~любая, какой вы раньше не пользовались~~ tarantool.
 
 Репозиторий — https://github.com/lberserq/nodespec2016_table_njs
...
## 2 курс
 ...
 Репозиторий — [mymedia2/nodejs-news](https://github.com/mymedia2/nodejs-news).
