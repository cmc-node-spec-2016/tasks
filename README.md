...
## 3 курс
 ...
 Файлы могут быть публичными и приватными (доступны только по ссылке-ключу, не индексируются), у них может быть описание и метки. 
 ...
 Метки задаются внутри описания через `#метка`.
